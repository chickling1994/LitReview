...
\begin{table}[H]
    ...
    \begin{tabular}{|p{1cm}|p{2.5cm}|p{9cm}|p{1.5cm}|}
                ...
                \hline
                3 & Analyse the error sources using fibre optics& Compare results to free space using the interferometer system described in Jacob Brunners Thesis, \autocite{Brunner2017}. Attempt to achieve a phase error of 3$mRad$ or less.& 2\\
                \hline
